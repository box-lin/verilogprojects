...
HD_PWD='C:/Users/boxiang/Desktop/ee_214_projects/project_1_require_3/project_1_require_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log led_all.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source led_all.tcl -notrace
