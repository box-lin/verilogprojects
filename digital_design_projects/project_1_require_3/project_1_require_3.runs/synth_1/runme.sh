...
HD_PWD='C:/Users/boxiang/Desktop/ee_214_projects/project_1_require_3/project_1_require_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log led_all.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source led_all.tcl
