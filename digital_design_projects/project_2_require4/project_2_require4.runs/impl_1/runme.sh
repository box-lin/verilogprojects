...
HD_PWD='C:/Users/boxiang/Desktop/ee_214_projects/project_2_require4/project_2_require4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log p2_require4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source p2_require4.tcl -notrace
