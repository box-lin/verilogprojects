...
HD_PWD='C:/Users/boxiang/Desktop/ee_214_projects/project_5_challenge/project_5_challenge.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log p5c1_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source p5c1_wrapper.tcl
