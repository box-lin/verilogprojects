...
HD_PWD='C:/Users/boxiang/Desktop/ee_214_projects/project_5_challenge/project_5_challenge.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log p5c1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source p5c1_wrapper.tcl -notrace
