...
HD_PWD='C:/Users/boxiang/Desktop/ee_214_projects/project_5_require2/project_5_require2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log p5r2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source p5r2.tcl -notrace
