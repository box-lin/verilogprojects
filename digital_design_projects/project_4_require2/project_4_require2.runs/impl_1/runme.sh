...
HD_PWD='C:/Users/boxiang/Desktop/ee_214_projects/project_4_require2/project_4_require2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log p4r2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source p4r2.tcl -notrace
