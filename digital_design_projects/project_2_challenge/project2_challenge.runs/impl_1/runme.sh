...
HD_PWD='C:/Users/boxiang/Desktop/ee_214_projects/project2_challenge/project2_challenge.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log p2_challenge.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source p2_challenge.tcl -notrace
