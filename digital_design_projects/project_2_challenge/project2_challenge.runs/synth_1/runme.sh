...
HD_PWD='C:/Users/boxiang/Desktop/ee_214_projects/project2_challenge/project2_challenge.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log p2_challenge.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source p2_challenge.tcl
