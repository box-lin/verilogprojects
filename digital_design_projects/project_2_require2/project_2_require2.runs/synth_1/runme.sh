...
HD_PWD='C:/Users/boxiang/Desktop/ee_214_projects/project_2_require2/project_2_require2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log p2_require2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source p2_require2.tcl
