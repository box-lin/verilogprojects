...
HD_PWD='C:/Users/boxiang/Desktop/ee_214_projects/project_4_require1modify/project_4_require1modify.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log p4r1_8bits.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source p4r1_8bits.tcl -notrace
