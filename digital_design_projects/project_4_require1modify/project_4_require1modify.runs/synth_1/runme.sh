...
HD_PWD='C:/Users/boxiang/Desktop/ee_214_projects/project_4_require1modify/project_4_require1modify.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log p4r1_8bits.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source p4r1_8bits.tcl
