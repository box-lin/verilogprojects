...
HD_PWD='C:/Users/boxiang/Desktop/ee_214_projects/project_7_4/project_7_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log p7r4_Register.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source p7r4_Register.tcl -notrace
