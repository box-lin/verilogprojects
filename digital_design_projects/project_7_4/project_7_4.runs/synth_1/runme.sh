...
HD_PWD='C:/Users/boxiang/Desktop/ee_214_projects/project_7_4/project_7_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log p7r4_Register.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source p7r4_Register.tcl
