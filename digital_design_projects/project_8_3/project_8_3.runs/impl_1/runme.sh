...
HD_PWD='C:/Users/boxiang/Desktop/ee_214_projects/project_8_3/project_8_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log p8r3_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source p8r3_top.tcl -notrace
