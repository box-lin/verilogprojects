...
HD_PWD='C:/Users/boxiang/Desktop/ee_214_projects/project_3_requre2/project_3_requre2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log p3require2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source p3require2.tcl -notrace
