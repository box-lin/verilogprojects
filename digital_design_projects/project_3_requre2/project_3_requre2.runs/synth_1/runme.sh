...
HD_PWD='C:/Users/boxiang/Desktop/ee_214_projects/project_3_requre2/project_3_requre2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log p3require2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source p3require2.tcl
