...
HD_PWD='C:/Users/boxiang/Desktop/ee_214_projects/project_1_challenge_1/project_1_challenge_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log challenge_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source challenge_1.tcl -notrace
