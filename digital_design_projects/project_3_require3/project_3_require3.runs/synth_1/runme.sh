...
HD_PWD='C:/Users/boxiang/Desktop/ee_214_projects/project_3_require3/project_3_require3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log p3require3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source p3require3.tcl
