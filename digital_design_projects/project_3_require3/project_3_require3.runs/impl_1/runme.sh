...
HD_PWD='C:/Users/boxiang/Desktop/ee_214_projects/project_3_require3/project_3_require3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log p3require3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source p3require3.tcl -notrace
