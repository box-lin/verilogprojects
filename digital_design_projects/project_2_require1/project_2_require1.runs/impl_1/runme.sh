...
HD_PWD='C:/Users/boxiang/Desktop/ee_214_projects/project_2_require1/project_2_require1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log p2_require1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source p2_require1.tcl -notrace
