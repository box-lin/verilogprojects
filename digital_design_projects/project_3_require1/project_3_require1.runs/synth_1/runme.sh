...
HD_PWD='C:/Users/boxiang/Desktop/ee_214_projects/project_3_require1/project_3_require1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log p3require1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source p3require1.tcl
