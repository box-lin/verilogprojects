...
HD_PWD='C:/Users/boxiang/Desktop/ee_214_projects/project_1_for_3/project_1_for_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log led_for.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source led_for.tcl -notrace
