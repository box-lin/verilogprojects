...
HD_PWD='C:/Users/boxiang/Desktop/ee_214_projects/project_1_require_4/project_1_require_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log led_reverse.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source led_reverse.tcl
