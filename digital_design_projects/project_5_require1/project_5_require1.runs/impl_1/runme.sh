...
HD_PWD='C:/Users/boxiang/Desktop/ee_214_projects/project_5_require1/project_5_require1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log p5r1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source p5r1_wrapper.tcl -notrace
