...
HD_PWD='C:/Users/boxiang/Desktop/ee_214_projects/project_5_require1/project_5_require1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log p5r1_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source p5r1_wrapper.tcl
