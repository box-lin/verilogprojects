...
HD_PWD='C:/Users/boxiang/Desktop/ee_214_projects/project_1_require_2/project_1_require_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log require2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source require2.tcl
