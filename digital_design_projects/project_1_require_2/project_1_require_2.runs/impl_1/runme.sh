...
HD_PWD='C:/Users/boxiang/Desktop/ee_214_projects/project_1_require_2/project_1_require_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log require2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source require2.tcl -notrace
