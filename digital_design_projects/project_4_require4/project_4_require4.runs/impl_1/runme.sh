...
HD_PWD='C:/Users/boxiang/Desktop/ee_214_projects/project_4_require4/project_4_require4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log p4r4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source p4r4.tcl -notrace
