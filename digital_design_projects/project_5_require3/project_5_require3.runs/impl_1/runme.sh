...
HD_PWD='C:/Users/boxiang/Desktop/ee_214_projects/project_5_require3/project_5_require3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log p5r3wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source p5r3wrapper.tcl -notrace
