...
HD_PWD='C:/Users/boxiang/Desktop/ee_214_projects/project_8_1/project_8_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log p8r1_clk_divider.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source p8r1_clk_divider.tcl -notrace
