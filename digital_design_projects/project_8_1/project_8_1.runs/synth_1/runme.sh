...
HD_PWD='C:/Users/boxiang/Desktop/ee_214_projects/project_8_1/project_8_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log p8r1_clk_divider.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source p8r1_clk_divider.tcl
